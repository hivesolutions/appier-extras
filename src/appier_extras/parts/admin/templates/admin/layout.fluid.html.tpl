...
{% block html %}
    ...
    <body class="ux wait-load fluid grey no-footer {{ sub_layout_r }} {{ theme_r }} {{ style_r }} {{ style_flags }} {% block body_class %}{% endblock %}" style="{% block body_style %}{% endblock %}" data-id="admin">
        {% block extras %}
