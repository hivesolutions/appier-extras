...
class LogglyHandler(logging.Handler):
    def __init__(
        self, level=logging.NOTSET, owner=None, api=None, buffer_size=128, timeout=30
    ):
    ...
    def emit(self, record):
        ...
        # to the loggly infra-structure, this should represent a
    ...
    def flush(self, force=False):
        ...
        call_log = lambda: self.api.log_bulk(buffer, tag="default")
